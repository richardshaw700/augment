...
This module handles dynamic feedback and guidance that gets injected into GPT prompts
...
class PerformanceInjections:
    ...
    def generate_efficiency_tip(action_count: int, time_elapsed: float) -> str:
        ...
        if action_count > 10:
            return "⚡ Consider using action sequences (field parameter) to reduce action count"
        elif time_elapsed > 30:
            return "⏱️ Task taking longer than expected - verify if goal is already achieved"
        return ""

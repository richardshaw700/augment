...
- Uses percentage coordinate system (0:0 to 100:100) for target resolution
- **Example guidance:** ACTION: CLICK | target=txt:iMessage → LLM finds txt:iMessage@23:49 in UI
